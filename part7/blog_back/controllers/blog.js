...
blogRouter.post("/:id/comment", async (request, response) => {
  console.log("in add comment back");
  const blogId = request.params.id;
  const body = request.body;

  console.log("in add comment back", blogId, body);
...
blogRouter.delete("/:id/comment/:commentId", async (request, response) => {
  console.log("in add comment back");
  const blogId = request.params.id;
...
blogRouter.get("/:id", async (request, response) => {
  ...
  console.log("blogRouter blog========", blog);
  ...
  if (!blog) {
    ...
    const data = {
      ...
      user: blog.user
        ...
        : null,
      comments: (comments ?? []).map((item) => item.content),
    };
